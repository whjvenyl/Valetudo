    ...
    <div class="content">
      ...
      <div v-if="wifi">
        <v-ons-list-title style="margin-top:5px;"
          >Current connection</v-ons-list-title
        >
        <v-ons-list>
          <v-ons-list-item>
            <div class="left">
            ...
            <div
              class="right"
              id="settings-wifi-current-connection-status-connected"
            >
          ...
          <v-ons-list-item>
            ...
            <div
              class="right"
              id="settings-wifi-current-connection-status-ssid"
            >
          ...
          <v-ons-list-item>
            ...
            <div
              class="right"
              id="settings-wifi-current-connection-status-signal"
            >
          ...
          <v-ons-list-item>
            ...
            <div
              class="right"
              id="settings-wifi-current-connection-status-tx-bitrate"
            >
        ...
        <v-ons-list-title style="margin-top:20px;"
          >Wifi Settings</v-ons-list-title
        >
        <v-ons-list>
          <v-ons-list-item>
            <div class="left">
          ...
          <v-ons-list-item>
            ...
            <label class="right" style="width:75%">
              <v-ons-input
                id="settings-wifi-input-password"
                v-model="password"
                type="password"
                float
                maxlength="63"
          ...
          <v-ons-list-item>
            <div class="center">
              <v-ons-button
                id="settings-wifi-input-save-button"
                modifier="large"
                class="button-margin"
                :disabled="fetching || ssid.length < 1 || password.length < 1"
                @click="handleWifiSettingsSaveButton()"
...
export default class WifiSettings extends Vue {
  ...
  public async handleWifiSettingsSaveButton() {
    const answer = (await notification.confirm(
      "Are you sure you want to apply the new wifi settings?<br><br>" +
