<template>
  <v-ons-page>
    ...
    <v-ons-list-title style="margin-top:20px;"
      >Save Go To spot as</v-ons-list-title
    >
    <v-ons-list>
      <v-ons-list-item>
        <div class="left">
      ...
      <v-ons-list-item>
        <div class="center">
          <v-ons-button
            id="zones-config-go-to-save-button"
            :disabled="fetching"
            modifier="large"
            class="button-margin"
            @click="saveGoto()"
    ...
    <v-ons-list-title style="margin-top:20px;"
      >Delete Go To spot</v-ons-list-title
    >
    <v-ons-list>
      <v-ons-list-item>
        <div class="center">
