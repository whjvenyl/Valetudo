  ...
  <v-ons-page>
    ...
    <div class="content">
      ...
      <v-ons-list-title style="margin-top:20px;"
        >Sound Volume Settings</v-ons-list-title
      >
      <v-ons-list>
        <v-ons-list-item>
          <div class="left">
            ...
            <v-ons-row>
              ...
              <v-ons-col>
                <v-ons-range
                  ...
                  style="width: 100%;"
                  v-model="volume"
                  id="settings-sound-volume-input-volume"
                ></v-ons-range>
              </v-ons-col>
              <v-ons-col
                width="40px"
        ...
        <v-ons-list-item>
          <div class="center">
            <v-ons-button
              id="settings-sound-volume-input-save-button"
              :disabled="fetching"
              modifier="large"
              class="button-margin"
              @click="doSaveVolume()"
        ...
        <v-ons-list-item>
          <div class="center">
            <v-ons-button
              id="settings-sound-volume-input-test-button"
              :disabled="fetching"
              modifier="large"
              class="button-margin"
              @click="testVolume()"
