  ...
  <v-ons-page>
    ...
    <div class="content">
      ...
      <v-ons-list-title style="margin-top:20px;"
        >Cleanup area {{ fetching }} definition</v-ons-list-title
      >
      <v-ons-list>
        <v-ons-list-item>
          <div class="left">
        ...
        <v-ons-list-item>
          <div class="center">
            <v-ons-button
              id="zones-config-zone-areabutton"
              :disabled="fetching"
              modifier="large"
              class="button-margin"
              @click="startZoneCleanup()"
              >Clean zone
            </v-ons-button>
          </div>
        </v-ons-list-item>
      ...
      <v-ons-list-title style="margin-top:20px;"
        >Save area as new Zone</v-ons-list-title
      >
      <v-ons-list>
        <v-ons-list-item>
          <div class="left">
      ...
      <v-ons-list-title style="margin-top:20px;"
        >Add area to existing Zone</v-ons-list-title
      >
      <v-ons-list>
        <v-ons-list-item>
          <div class="center">
